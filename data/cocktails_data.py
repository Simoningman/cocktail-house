...
All cocktail recipes, spirits and flavor data.
"""
...
COCKTAILS = [
    ...
    },
    {
        ...
        "steps": [
            "Pre-warm the glass with hot water, then discard.",
            "Add whiskey and sugar syrup to the glass.",
            "Pour in hot coffee and stir until sugar is dissolved.",
            "Float lightly whipped cream over the back of a spoon — it should sit on top.",
    ...
    },
    {
        ...
        "spirit": "vodka",
        "spirit_label": "Vodka",
        "flavors": ["sweet", "creamy", "coffee", "rich"],
        "difficulty": "Very easy",
        "glass": "Irish coffee glass",
        "ingredients": [
        ...
        "steps": [
            "Pre-warm the glass with hot water, then discard.",
            "Add Baileys and Cointreau to the glass.",
            "Pour in hot coffee and stir gently.",
    ...
    },
    {
        ...
        "emoji": "🍀",
        "spirit": "other",
        "spirit_label": "Baileys",
        "flavors": ["sweet", "creamy", "coffee", "smooth"],
        "difficulty": "Very easy",
        "glass": "Irish coffee glass",
        "ingredients": [
        ...
        "steps": [
            "Pre-warm the glass with hot water, then discard.",
            "Pour Baileys into the warm glass.",
            "Add hot coffee and stir gently.",
            "Float lightly whipped cream over the back of a spoon.",
            "Drink through the cream — do not stir.",
        ],
    ...
    {
        "id": 107,
        "name": "Galliano Hot Shot",
        "emoji": "🔥",
        "spirit": "other",
        "spirit_label": "Galliano",
        "flavors": ["sweet", "herbal", "coffee", "warm"],
        "difficulty": "Easy",
        "glass": "Shot glass",
        "ingredients": [
            ("2 cl", "Galliano L'Autentico"),
            ("2 cl", "Hot strong coffee"),
            ("2 cl", "Lightly whipped cream"),
        ],
        "steps": [
            "Pour Galliano into a shot glass — it forms the bottom layer.",
            "Slowly pour hot espresso over the back of a spoon to create the middle layer.",
            "Gently float lightly whipped cream on top as the final layer.",
            "Serve immediately — drink in one shot through all three layers.",
        ],
    ...
    },
     {
        ...
        "spirit": "gin",
        "spirit_label": "Gin",
        "flavors": ["citrus", "elegant", "sweet", "herbal"],
        "difficulty": "Medium",
        "glass": "Coupe glass",
        "ingredients": [
            ("30 ml", "Gin"),
    ...
    },
    {
        ...
        "spirit": "rum",
        "spirit_label": "Rum",
        "flavors": ["tropical", "sweet", "herbal", "citrus"],
        "difficulty": "Easy",
        "glass": "Coupe or rocks glass",
        "ingredients": [
            ("30 ml", "White rum"),
    ...
    },
    {
        ...
        "spirit": "whiskey",
        "spirit_label": "Whiskey / Bourbon",
        "flavors": ["citrus", "fresh", "sweet", "light"],
        "difficulty": "Easy",
        "glass": "Collins glass",
        "ingredients": [
            ("50 ml", "Bourbon"),
    ...
    },
    {
        ...
        "spirit": "gin",
        "spirit_label": "Gin",
        "flavors": ["creamy", "citrus", "floral", "light"],
        "difficulty": "Hard",
        "glass": "Collins glass",
        "ingredients": [
            ("50 ml", "Gin"),
        ...
        "steps": [
            "Add all ingredients except soda to a shaker without ice.",
            "Dry shake vigorously for at least 5 minutes — traditionally 12 minutes.",
            "Add ice and shake again for 2 minutes.",
            "Strain into a Collins glass without ice.",
            "Slowly pour soda water down the side to create a tall foam head.",
        ],
    ...
    },
    {
        ...
        "spirit": "rum",
        "spirit_label": "Rum",
        "flavors": ["tropical", "sweet", "creamy", "citrus"],
        "difficulty": "Easy",
        "glass": "Rocks glass or tiki mug",
        "ingredients": [
            ("60 ml", "Dark rum"),
    ...
    },
    {
        ...
        "spirit": "rum",
        "spirit_label": "Rum",
        "flavors": ["sweet", "citrus", "complex", "elegant"],
        "difficulty": "Medium",
        "glass": "Coupe glass",
        "ingredients": [
            ("45 ml", "White rum"),
    ...
    },
    {
        ...
        "spirit": "tequila",
        "spirit_label": "Tequila",
        "flavors": ["sour", "citrus", "agave", "fresh"],
        "difficulty": "Easy",
        "glass": "Rocks glass",
        "ingredients": [
            ("50 ml", "Blanco tequila"),
    ...
    },
    {
        ...
        "steps": [
            "Fill a copa or highball glass with ice.",
            "Pour in Aperol.",
            "Top with tonic water — pour slowly down the side.",
            "Garnish with orange slice.",
        ],
    ...
    },
    {
        ...
        "ingredients": [
            ("60 ml", "Lillet Blanc"),
            ("90 ml", "Soda water"),
            ("Garnish", "Orange or lemon slice + fresh herbs"),
        ],
        "steps": [
            "Fill a wine glass with ice.",
            "Pour in Lillet Blanc.",
            "Top with soda water.",
            "Garnish with citrus and fresh herbs like thyme or rosemary.",
        ],
    ...
    },
    {
        ...
        "ingredients": [
            ("15 ml", "Crème de cassis"),
            ("Top", "Dry white wine"),
            ("Garnish", "Blackcurrant or lemon twist"),
        ],
        "steps": [
            "Pour crème de cassis into a chilled wine glass.",
            "Top with cold dry white wine.",
            "Garnish and serve immediately.",
        ],
    ...
    },
    {
        ...
        "steps": [
            ...
            "Double strain into a chilled coupe.",
            "No garnish needed — the vivid green colour is the presentation.",
        ],
    ...
    },
    {
        ...
        "spirit": "vodka",
        "spirit_label": "Vodka",
        "flavors": ["spicy", "savory", "citrus", "strong"],
        "difficulty": "Medium",
        "glass": "Highball glass",
        "ingredients": [
            ("50 ml", "Vodka"),
        ...
        "steps": [
            "Add all ingredients to a shaker with ice.",
            "Roll gently between two glasses — don't shake, it aerates the tomato juice.",
            "Pour into a highball glass with ice.",
            "Garnish with celery and lemon.",
            "Season to taste — every Bloody Mary should be adjusted individually.",
        ],
